...
export function PlayerIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PlatformIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GroundIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CollectibleIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CoinIcon({ size = 16, className = '' }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 6v12" />
      <path d="M15 9.5c-.5-1-1.5-1.5-3-1.5s-3 1-3 2.5 1 2 3 2.5 3 1.5 3 2.5-1.5 2.5-3 2.5-2.5-.5-3-1.5" />
    </svg>
  );
}

export function EnemyIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function EntityIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ComponentIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SpriteIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function VelocityIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ColliderIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function InputIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DebugIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MoveIcon({ size = 16, className = '' }: IconProps) {
  return (
    ...
    >
      <path d="M12 2v20M2 12h20" />
      <path d="m16 8-4-4-4 4M8 16l4 4 4-4M16 16l4-4-4-4M8 8l-4 4 4 4" />
    </svg>
  );
}

export function NewProjectIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SoundIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ResetZoomIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FitAllIcon({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LoadingSpinner({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PuzzleIcon({ size = 16, className = "" }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M19.439 15.424a1 1 0 00-1.026-.063l-4.5 2.25a1 1 0 00-.553.894V21a1 1 0 001 1h4a1 1 0 001-1v-4.5a1 1 0 00-.456-.83l-1.5-1.071c-.02-.014-.424-.265-.965-.175z" />
      <path d="M4 14a1 1 0 011 1v4.5a1 1 0 001 1h4a1 1 0 001-1v-2.5a1 1 0 00-.553-.894l-4.5-2.25a1 1 0 00-1.026.063c-.54.09-.945.341-.965.355l-1.5 1.07A1 1 0 003 16v4a1 1 0 001 1h.5" />
      <path d="M10 3a1 1 0 00-1 1v4.5a1 1 0 00.553.894l4.5 2.25a1 1 0 001.026-.063c.54-.09.945-.341.965-.355l1.5-1.07A1 1 0 0018 9V5a1 1 0 00-1-1h-4a1 1 0 00-1 1" />
      <path d="M4 10a1 1 0 001-1V4.5a1 1 0 00-.553-.894l-4.5-2.25A1 1 0 003 2v4a1 1 0 001 1h.5" />
...
export function SceneIcon({ size = 16, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PhysicsIcon({ size = 16, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MicrophoneOffIcon({ size = 16, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StopCircleIcon({ size = 16, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
