    ...
    <div className="p-4 bg-red-900/20 border-l-4 border-red-500 rounded-r-lg">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          <p className="text-sm text-red-200/80 mt-1 ml-7">{suggestion}</p>
          {action && (
            <p className="text-sm text-red-300/70 mt-2 ml-7 flex items-center gap-1">
        ...
        {onDismiss && (
          <button
            onClick={onDismiss}
            className="text-red-400 hover:text-red-300 p-1 -mt-1 -mr-1 transition-colors"
            title="Dismiss"
          >
